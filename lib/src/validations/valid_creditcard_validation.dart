...
extension ValidCreditCardValidation on SimpleValidationBuilder<String> {
  ...
  SimpleValidationBuilder<String> validCreditCard(
    ...
    return useValidation(
      (value, entity) => _validateCreditCard(value),
      code: code ?? Language.code.validCreditCard,
      message: message,
    );
  }
}
...
extension ValidCreditCardNullableValidation
  ...
  SimpleValidationBuilder<String?> validCreditCard(
      {String? message, String? code}) {
    return useValidation(
      (value, entity) => value != null && _validateCreditCard(value),
      code: code ?? Language.code.validCreditCard,
      message: message,
    );
  }
...
extension ValidCreditCardOrNullableValidation
    on SimpleValidationBuilder<String?> {
  ...
  /// - **{PropertyName}**: The name of the property.
  ///
  SimpleValidationBuilder<String?> validCreditCardOrNull(
      {String? message, String? code}) {
    return useValidation(
      (value, entity) => value == null || _validateCreditCard(value),
      code: code ?? Language.code.validCreditCard,
