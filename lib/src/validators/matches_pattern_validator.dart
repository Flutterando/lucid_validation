...
extension MatchesPatternValidator on LucidValidationBuilder<String> {
  ...
  /// ```
  LucidValidationBuilder<String> matchesPattern(String pattern, {String message = 'Invalid format', String code = 'invalid_format'}) {
    return registerRule(
